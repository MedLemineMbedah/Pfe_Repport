...
\begin{figure}[h!]
	...
	\label{fig:birds}
\end{figure}
En commentant les sous-titres précédents, nous pouvons dire que nous avons utilisé le framework Flutter comme Frontend, pour développer l'application mobile et le framework Laravel comme backend, pour développer l'API serveur.
