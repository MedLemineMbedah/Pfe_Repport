...
%	\textbf{UI} : User Interface  
	...
	\listoftables
	\thispagestyle{empty}
	\input{./Template LaTeX/TeXFiles/newIntro}
	%\input{./Template LaTeX/TeXFiles/Introduction}
	\input{./Template LaTeX/TeXFiles/PresentationDeLaSociete}
	%\input{./Template LaTeX/TeXFiles/Analyse}
	\input{./Template LaTeX/TeXFiles/EnvironnementDeTravail}
	\input{./Template LaTeX/TeXFiles/new_realisation}
	\input{./Template LaTeX/TeXFiles/new_Conclusion}
%	\input{./Template LaTeX/TeXFiles/perspectives}
	\input{./Template LaTeX/TeXFiles/Bibliographie}
	%\input{./Template LaTeX/TeXFiles/Realisation}
	%\input{./Template LaTeX/TeXFiles/Interface}	
\end{document}